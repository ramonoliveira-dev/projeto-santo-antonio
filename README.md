# 🕊️ Grupo de Oração Santo Antônio - Inclusão Digital

> Projeto front-end responsivo desenvolvido para facilitar a comunicação e a organização das atividades sociais de um grupo comunitário localizado no bairro Granja Portugal, em Fortaleza/CE.
...
O projeto foi construído sem o uso de frameworks externos para priorizar o aprendizado das bases da web e garantir máxima leveza:

* **HTML5:** Estruturação semântica.
* **CSS3:** Estilização, variáveis globais, hover effects e media queries.
* **JavaScript (Vanilla):** Lógica do menu mobile e observador de rolagem para as animações dinâmicas.

## 🚀 Como visualizar o projeto

O projeto está publicado e pode ser acessado diretamente pelo link abaixo:

🔗 **[Acessar o site do Grupo de Oração Santo Antônio]([https://projeto-santo-antonio.vercel.app/index.html](https://santoantoniogranja.vercel.app/))**
